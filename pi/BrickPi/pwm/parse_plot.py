...
if __name__ == "__main__":
    ...
    # plot rm
    plt.figure(1)
    plt.title("Right motor reference and actual angle: Kp="+k_pr+", Ki="+k_ir+", Kd="+k_dr+", pwm="+pwm)
    plt.xlabel("time (ns)")
    ...
    plt.figure(2)
    plt.title("Right motor absolute error: Kp="+k_pr+", Ki="+k_ir+", Kd="+k_dr+", pwm="+pwm)
    plt.xlabel("time (ns)")
    plt.ylabel("angle (radians)")
    ...
    # plot lm
    plt.figure(3)
    plt.title("Left motor reference and actual angle: Kp="+k_pl+", Ki="+k_il+", Kd="+k_dl+", pwm="+pwm)
    plt.xlabel("time (ns)")
    plt.ylabel("angle (radians)")
    ...
    plt.figure(4)
    plt.title("Left motor absolute error: Kp="+k_pl+", Ki="+k_il+", Kd="+k_dl+", pwm="+pwm)
    plt.xlabel("time (ns)")
    plt.ylabel("angle (radians)")
